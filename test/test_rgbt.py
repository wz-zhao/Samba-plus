...
parser.add_argument('--model_path', type=str, default='./checkpoints/Samba/rgbt_datasets/Samba_rgbt.pth')
parser.add_argument('--test_dataset', type=list, default=['VT821','VT1000','VT5000'])
...
for i, data_batch in enumerate(test_loader):
    ...
    image, depth, name, split, size = data_batch['image'], data_batch['depth'], \
